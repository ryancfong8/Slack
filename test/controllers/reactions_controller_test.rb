...
class ReactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create reaction' do
    assert_difference('Reaction.count') do
      post reactions_url,
           params: { reaction: { emoji: @reaction.emoji, message_id: @reaction.message_id,
  ...
  test 'should update reaction' do
    patch reaction_url(@reaction),
          params: { reaction: { emoji: @reaction.emoji, message_id: @reaction.message_id, user_id: @reaction.user_id } }
